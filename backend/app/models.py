...
class Arma(BaseModel):
    ...
    daño: int | Literal["infinito"] = Field(..., description="Daño de 1 a 5 estrellas")
    ...
    reserva: int | Literal["infinito"] = Field(..., description="Munición en la recámara")
    ...
    papDaño: Optional[int] | Optional[Literal["infinito"]] = Field(None, description="Daño mejorado")
