...
class Arma(BaseModel):
    ...
    daño: int | Literal["infinito"] = Field(..., ge=0, description="Daño de 1 a 5 estrellas")
    ...
    reserva: int | Literal["infinito"] = Field(..., ge=0, description="Munición en la recámara")
    ...
    papDaño: Optional[int] | Optional[Literal["infinito"]] = Field(None, ge=0, description="Daño mejorado")
    ...
    papReserva: Optional[int] | Literal["infinito"] = Field(None, ge=0, description="Reserva mejorada")
